...
* Last Modified : 01:09:57 PM, 25-06-2021
...
class OnetLnet(object):

    def __init__(self):

        self.REFERENCE_FACIAL_POINTS = [[30.29459953, 51.69630051],
...
#             __file__, super.__str__(self))
    ...
    def get_reference_facial_points(self,
                                    output_size=None,
        ...
        scale_factor = size_bf_outer_pad[0].astype(
            np.float32) / tmp_crop_size[0]
    ...
    def get_affine_transform_matrix(self, src_pts, dst_pts):
    ...
    def warp_and_crop_face(self,
        ...
        if reference_pts is None:
            if crop_size[0] == 96 and crop_size[1] == 112:
                reference_pts = self.REFERENCE_FACIAL_POINTS
            else:
                default_square = True
                ...
                reference_pts = self.get_reference_facial_points(
